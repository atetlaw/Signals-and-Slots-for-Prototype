...
/*
 * Another IDEA:
 * $signal(object, 'functionname')
 * $signal(object, 'functionname').observe();
 * $signal(object, 'functionname').stopObserving();
 * $sig(object, 'functionname').stopObserving();
 * Event.signal(object, 'functionname').observe();
 * 
 */
Signal = {
	throwErrors : true,
